          ...
          <div className="mx-auto max-w-4xl space-y-10">
            ...
            <section className="space-y-6">
              <div className="rounded-3xl border-[3px] border-black bg-white p-5 md:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] space-y-3">
                <h2 className="text-lg md:text-xl font-black">1. INFORMATION WE COLLECT

                </h2>
                <ol className="text-sm md:text-base font-semibold text-black/75 leading-loose">

                  <li>1.1 <b>Personal Information</b>: Includes name, email, payment details, KYC information (where applicable), and other details provided during registration.
                  </li>

                  <li>1.2 <b>Non-Personal Information</b>: Includes browser type, IP address, and browsing activities.
              ...
              <div className="rounded-3xl border-[3px] border-black bg-white p-5 md:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] space-y-3">
                <h2 className="text-lg md:text-xl font-black">2. HOW WE USE YOUR INFORMATION


                </h2>
                <ol className="text-sm md:text-base font-semibold text-black/75 leading-loose">
                  <li>2.1 To provide and improve our services.</li>
                  <li>2.2 To process <b>tips</b> and manage transactions, including deducting platform fees and settling net amounts to Streamers.
                  </li>
                  <li>2.3 To communicate with Users about account updates and promotional offers.
                  </li>
                  <li>2.4 To comply with Indian legal requirements, including KYC verification, regulatory audits, and tax obligations.
                  </li>
                </ol>
              </div>

              <div className="rounded-3xl border-[3px] border-black bg-white p-5 md:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] space-y-3">
                <h2 className="text-lg md:text-xl font-black">3. DATA SHARING


                </h2>
                <ol className="text-sm md:text-base font-semibold text-black/75 leading-loose">

                  <li>3.1 We do not sell or rent your data to third parties.
                  </li>

                  <li>3.2 Data may be shared with:
                    <ul className="space-y-2 text-sm md:text-base font-semibold text-black/75 leading-relaxed list-disc ml-5">
                      <li>
                        <b>Payment gateways and banks
                        </b> (e.g., Razorpay) for transaction processing, settlements, and KYC verification.
                      </li>
                      <li>
                        Legal authorities, if required by Indian law or court orders.
              ...
              <div className="rounded-3xl border-[3px] border-black bg-white p-5 md:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] space-y-3">
                <h2 className="text-lg md:text-xl font-black">4. COOKIES</h2>
                <ol className="text-sm md:text-base font-semibold text-black/75 leading-loose">
                  <li>4.1 We use cookies to enhance your experience on our Website.</li>
                  <li>4.2 Users can disable cookies through their browser settings, though some functionalities may be affected.</li>
                </ol>
              </div>


              <div className="rounded-3xl border-[3px] border-black bg-white p-5 md:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] space-y-3">
                <h2 className="text-lg md:text-xl font-black">5. DATA SECURITY</h2>
                <ol className="text-sm md:text-base font-semibold text-black/75 leading-loose">
                  <li>5.1 We implement industry-standard measures to protect your data from unauthorized access, alteration, or disclosure.</li>
                  <li>5.2 All data is stored securely in compliance with Indian data protection laws.</li>
                </ol>
              </div>


              <div className="rounded-3xl border-[3px] border-black bg-white p-5 md:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] space-y-3">
                <h2 className="text-lg md:text-xl font-black">6. USER RIGHTS</h2>
                <ol className="text-sm md:text-base font-semibold text-black/75 leading-loose">
                  <li>6.1 Users have the right to access, update, or delete their personal data, subject to compliance obligations (e.g., KYC data retention required by law).</li>
                  <li>6.2 Requests can be submitted via <a
                    href="mailto:support@potatopay.co"
                    className="underline font-black"
                  >
                    support@potatopay.co
                  </a>  and will be handled in accordance with Indian regulations.</li>
                </ol>
              </div>
              ...
              <div className="rounded-3xl border-[3px] border-black bg-white p-5 md:p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] space-y-3">
                <h2 className="text-lg md:text-xl font-black">10. CONTACT INFORMATION</h2>
